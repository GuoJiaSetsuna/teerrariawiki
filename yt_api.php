					...
					<div id="main">
						...
						<!-- Posts -->
							<section class="posts">
								...
								$url = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet,contentDetails,status&playlistId=UUq3QzpKNapKhCl4jpgQB44w&key=AIzaSyCrHBMteUxt1eGbH8zGw-XeE5onLWNB4oE&maxResults=36";
								//將所抓取的API json檔做處理
